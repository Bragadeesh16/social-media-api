...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='create_community_model',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('community_profile', models.ImageField(blank=True, upload_to='community_profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('command_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='command_by', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='community_post',
            fields=[
                ...
                ('community', models.ManyToManyField(related_name='posts', to='myapp.create_community_model')),
                ('commands', models.ManyToManyField(blank=True, to='myapp.post_command')),
            ],
        ),
    ]
